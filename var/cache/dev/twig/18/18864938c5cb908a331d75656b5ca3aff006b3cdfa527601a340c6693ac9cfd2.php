...
class __TwigTemplate_69a4286fee21f78dfac107febbed8ef166a9ba92d173cfca3e0c93f7519b7e96 extends Template
{
    private $source;
    private $macros = [];
...
";
            ...
            echo "\">";
            echo twig_escape_filter($this->env, twig_replace_filter((isset($context["value"]) || array_key_exists("value", $context) ? $context["value"] : (function () { throw new RuntimeError('Variable "value" does not exist.', 4, $this->source); })()), ["https://" => "", "http://" => ""]), "html", null, true);
            echo "</a>
";
        }
...
{% else %}
    <a target=\"_blank\" href=\"{{ value }}\">{{ value|replace({ 'https://': '', 'http://': '' }) }}</a>
{% endif %}
", "@EasyAdmin/default/field_url.html.twig", "C:\\OpenServer\\domains\\SM\\templates\\bundles\\EasyAdminBundle\\default\\field_url.html.twig");
    }
}
