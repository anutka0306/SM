...
class __TwigTemplate_1129b493f27af44ad525b3ee1965f5432b995b5a312cf82ffa29c568c3f1fa60 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("@!EasyAdmin/default/layout.html.twig", "@EasyAdmin/default/layout.html.twig", 1);
    ...
    public function block_header_custom_menu($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    <div class=\"header_custom_menu\">
        <div class=\"alert alert-success success-msg\"></div>
        <div class=\"alert alert-danger error-msg\"></div>
        <div class=\"btn btn-warning cache-clear-button\" data-url=\"";
        // line 7
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_cache_clear");
        echo "\">Очистить кэш</div>
        <div class=\"btn btn-primary\"><a href=\"/\" target=\"_blank\">На главную</a></div>
        ";
        // line 9
        $this->displayParentBlock("header_custom_menu", $context, $blocks);
        echo "
    </div>
";
...
{% block header_custom_menu %}
    <div class=\"header_custom_menu\">
        <div class=\"alert alert-success success-msg\"></div>
        <div class=\"alert alert-danger error-msg\"></div>
        <div class=\"btn btn-warning cache-clear-button\" data-url=\"{{ path('admin_cache_clear') }}\">Очистить кэш</div>
        <div class=\"btn btn-primary\"><a href=\"/\" target=\"_blank\">На главную</a></div>
        {{ parent() }}
    </div>
{% endblock header_custom_menu %}", "@EasyAdmin/default/layout.html.twig", "C:\\OpenServer\\domains\\SM\\templates\\bundles\\EasyAdminBundle\\default\\layout.html.twig");
    }
}
