...
class __TwigTemplate_4e1fbd754caedc98f852949f38f66e15e1c80765dbc8f99c2c191f337022d9ce extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-primary btn-lg btn-block\">{{ button_label|default('Сохранить') }}</button>
{{ form_end(form) }}
", "salon/_form.html.twig", "C:\\OpenServer\\domains\\SM\\templates\\salon\\_form.html.twig");
    }
}
